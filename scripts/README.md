...
Auto-generated educational pentesting scripts.

> ⚠️ **EDUCATIONAL PURPOSES ONLY** — Always get authorization.

| Script | Topic | Date |
|--------|-------|------|
| [k8s_port_scanner.py](./k8s_port_scanner.py) | Kubernetes Port Scanner #Kubernetes #Cybersecurity #DevSecOps | 2026-02-27 |
